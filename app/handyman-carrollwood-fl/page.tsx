...
export const metadata: Metadata = buildMetadata({
  title: `Professional Handyman Services in Carrollwood | ${siteConfig.shortName}`,
  description:
    "Professional handyman services in Carrollwood, FL. Ceiling fan installation, home maintenance, and punch-list projects. Call Handyman Pros FL for a free estimate.",
  path: pagePath,
  keywords: [
    "Professional Handyman Services in Carrollwood",
...
export default function HandymanCarrollwoodPage() {
  return (
    <>
          ...
          <div className="grid items-start gap-8 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="mx-auto w-full max-w-3xl lg:mx-0">
              ...
              <p className="location-intro mb-6 text-xl leading-relaxed text-[hsl(var(--muted-foreground))]">
                Handyman Pros FL delivers professional handyman services in Carrollwood — from ceiling fan installation to everyday repairs — with the care of a true local handyman service.
              </p>
              ...
              <div className="location-body prose-content space-y-5 text-base leading-relaxed text-[hsl(var(--foreground))]">
                <p>
                  ...
                  Carrollwood Village, Northdale-adjacent streets, and blocks near Lake Carroll and Dale Mabry corridors with a fully stocked truck so most
                  common jobs start as soon as we arrive.
                </p>
                <p>
                  Choosing professional handyman services in Carrollwood means you get someone who understands Florida construction details —
                ...
                <p>
                  ...
                  reliable near community parks and pool decks. We provide upfront quotes, show up on time, and leave work areas neat.
                </p>
                <p>
          ...
          <section className="mx-auto mt-16 max-w-4xl" aria-labelledby="carrollwood-map-heading">
            <div className="mb-4 flex items-center gap-2">
              ...
              <h2 id="carrollwood-map-heading" className="text-2xl font-bold">
                Where does Handyman Pros FL serve in Carrollwood?
              </h2>
            </div>
      ...
      <CTASection
        title="Need Professional Handyman Services in Carrollwood?"
