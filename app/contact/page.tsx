        ...
        <div className="container-site">
          <div className="mx-auto mb-12 max-w-3xl text-center">
            ...
            <p className="text-lg text-[hsl(var(--muted-foreground))]">
              Based at {fullAddress}. Call anytime — we&apos;re open 24/7 — or fill out the short form for a free estimate.
            </p>
          </div>

          <div className="grid gap-12 lg:grid-cols-2">
            <div>
              <h2 className="mb-6 text-2xl font-bold">How do I reach a handyman in Tampa today?</h2>
              <div className="space-y-6">
                <a href={`tel:${siteConfig.phoneTel}`} className="flex items-start gap-4 rounded-xl border border-[hsl(var(--border))] bg-white/80 p-4 transition-colors hover:border-[hsl(var(--primary))]">
                  <Phone className="mt-1 h-6 w-6 shrink-0 text-[hsl(var(--primary))]" />
                  <div>
                ...
                <a href={`mailto:${siteConfig.email}`} className="flex items-start gap-4 rounded-xl border border-[hsl(var(--border))] bg-white/80 p-4 transition-colors hover:border-[hsl(var(--primary))]">
                  <Mail className="mt-1 h-6 w-6 shrink-0 text-[hsl(var(--primary))]" />
                  <div>
                ...
                >
                  <MapPin className="mt-1 h-6 w-6 shrink-0 text-[hsl(var(--primary))]" />
                  <div>
                ...
                <div className="flex items-start gap-4 rounded-xl border border-[hsl(var(--border))] bg-white/80 p-4">
                  <Clock className="mt-1 h-6 w-6 shrink-0 text-[hsl(var(--primary))]" />
                  <div>
            ...
            <QuoteForm title="Get a Free Quote" />
          </div>
        </div>
      </section>
    </>
