...
const MOCK_API_KEY = "t2p_live_sk_8f3a9c2e1b7d4f6a0e5c8b3d9f2a7e1"
...
export default function DeveloperDashboardPage() {
  ...
  const maskedKey = MOCK_API_KEY.replace(/(?<=t2p_live_sk_).+/g, "•".repeat(24))
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">t2pproof.link API</p>
              </div>
            </div>
          </div>
      ...
      <main className="mx-auto max-w-7xl px-4 py-10">
        ...
        <div className="mt-8 rounded-xl border border-slate-800 bg-[#0c0c10] p-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h2 className="text-sm font-semibold text-white">Active API Key</h2>
              <p className="mt-1 text-xs text-slate-500">
                Use this key in your embed snippet or server-side verification calls.
              </p>
            </div>
            <button
              type="button"
          ...
          <div className="mt-4 flex items-center gap-3 rounded-lg border border-slate-800 bg-[#050508] px-4 py-3">
            ...
            <code className="flex-1 overflow-x-auto font-mono text-sm text-slate-300">
              {showApiKey ? MOCK_API_KEY : maskedKey}
            </code>
          </div>
        </div>
