...
import { VETTED_TOKENS } from "@/lib/mock-tokens"
      ...
      <div className="mb-8 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-xl text-sm leading-relaxed text-slate-400">
            Curated, non-scam tokens vetted by t2pproof.link. Prove your humanity with Pi to
            claim airdrops or view protected details.
          </p>
        </div>
              ...
              <div className="mt-4">
                {isUnlocked ? (
                  ...
                  <PiAuthButton
                    ...
                    size="sm"
                    className="w-full"
                    onSuccess={() => setUnlockedTokenId(token.id)}
                  >
