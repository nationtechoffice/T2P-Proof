        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="text-sm leading-relaxed">
              Tampa&apos;s trusted mobile handyman service. Licensed professionals serving Hillsborough County and all surrounding counties.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/services/handyman" className="hover:text-[hsl(var(--accent))]">Handyman Services</Link></li>
              <li><Link href="/services/painting" className="hover:text-[hsl(var(--accent))]">Painting Services</Link></li>
              <li><Link href="/services/fence" className="hover:text-[hsl(var(--accent))]">Fence Contractor</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/service-areas" className="hover:text-[hsl(var(--accent))]">Service Areas</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>Tampa &amp; Surrounding Counties, FL</span>
              </li>
            </ul>
          </div>
        </div>
